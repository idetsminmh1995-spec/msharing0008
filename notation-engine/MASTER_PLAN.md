...
Notation Engine. It supersedes `PLAN.md`, which is retained as a historical
reference only.

**Version:** 2.0 · **Supersedes:** `PLAN.md` (v1, the original 50-phase roadmap)
...
```
notation-engine/
  MASTER_PLAN.md          <- this file (authoritative)
  PLAN.md                 <- v1 roadmap, historical reference only
...
- `PLAN.md` is **historical reference only** and should not be edited further.
